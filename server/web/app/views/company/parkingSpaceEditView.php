    ...
    <div class="right-container">
      ...
      <form action="../parkingSpaceSaveView/<?php echo $data['parking_space']->parking_id ?>" method="POST" class="parking-form" onsubmit="saveFormData()">
        <div class="form-left">
          ...
          <input type="text" name="address" id="address" placeholder="Enter Parking Space Address" class="p-form-input width-75" required value="<?php echo $data['parking_space']->parking_address ?>">

          <div id="parkingSlotBatches">
            <p class="p-form-label">Parking Slots *</p>
            <?php foreach ($data['parking_space_status'] as $parking_slot) : ?>
              <div id="parkingSlotBatchForm" class="p-slot-batch">
                <label for="noOfSlots" class="p-form-label">Slots* </label>
                <input type="number" name="noOfSlots[]" class="p-form-input width-20" placeholder="No of slots" required value="<?php echo $parking_slot->each_type_total_slots ?>">
                ...
                <span class="p-form-label">Rs. <input type="number" name="parkingRate[]" placeholder="Price" class="p-form-input width-20" required value="<?php echo $parking_slot->each_type_rate ?>"> per Hour</span>
          ...
          <select name="parkingType" class="p-form-dropdown width-30">
            <option value="" disabled <?php if (empty($data['parking_space']->parking_is_public)) echo 'selected'; ?>>Type</option>
            <option value="public" <?php if ($data['parking_space']->parking_is_public) echo 'selected'; ?>>Public</option>
        ...
        <div class="form-right">
          <div class="p-location">
            <div class="p-latitude mr-10">
              ...
              <input type="text" id="latitude" name="latitude" class="p-form-input width-90" placeholder="Latitude" readonly value="<?php echo $data['parking_space']->parking_latitude ?>">
            </div>
