...
<head>
  ...
  <link rel="stylesheet" href="./styles/parkingOfficerView.css" />
  ...
  <div class="container">
    ...
    <div class="right-container">
      ...
      <div class="btn-section">
        <a href="./parkingOfficerFormView.php">
        ...
        <a href="./parkingOfficerEditView.php">
          <div class="btn bg-off-white">
        ...
        <a href="./parkingOfficerDeleteView.php">
          <div class="btn bg-off-white">
