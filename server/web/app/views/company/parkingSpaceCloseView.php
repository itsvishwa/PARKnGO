        ...
        <form action="<?php echo URLROOT; ?>companys/parkingSpaceCloseView/<?php echo $data['parking_space']->parking_id ?>" method="POST" enctype="multipart/form-data">
          <div class=" time-section">
            <div class="time-card ">
              ...
              <input type="datetime-local" id="closed_start_time" name="closed_start_time" class="p-form-input pr-5" required value="<?php echo $data['closed_start_time'] ?>">
            </div>
            <div class="time-card">
              <h4 class="f-14 mr-10">Until</h4>
              <input type="datetime-local" id="closed_end_time" name="closed_end_time" class="p-form-input pr-5" required value="<?php echo $data['closed_end_time'] ?>">
            </div>
          </div>
