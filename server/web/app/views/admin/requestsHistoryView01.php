...
<body>
  <div class="container">
    ...
    <div class="right-container">
      ...
      <div class="business">
        <div class="heading">
          <div class="b-card8-icon bg-green">
            <h4>Accepted </h4>
          </div>
          <div class="b-card9-icon bg-red">
            <h4>Rejected</h4>
          </div>
        </div>
            ...
            <div class="b-card01 bg-white">
             ...
             <!-- <div>
              ...
              <div>
                ...
                <div class="b-card4-icon ">
                  <div class="b-card4-content p text-black">
                    <?php
                ...
                <div class="b-card7-icon">
                  <div class="b-card4-content p text-black">
                    <p>
                      <?php
                      $timestamp = $application->registered_time_stamp;
                ...
                <div>
                <button class="b-card3-icon bg-white" type="button">
                  <div class="b-card3-content text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="green" class="menu-logo">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                    </svg>
                  </div>
              </div>
        ...
        <?php foreach ($data['rejectedApplications'] as $application) : ?>
         <!-- <div class="card-section bg-blue"> -->
              ...
              <div>
                ...
                <div class="b-card4-icon ">
                  ...
                  <p>Colombo</p> -->
                    ...
                    <?php
                    $address = $application->address; // Assuming $application->address contains the address retrieved from the database

                    // Split the address into lines based on a delimiter (e.g., comma)
                    $lines = explode(',', $address);

                    // Output the address lines with <p> tags and <br> for line breaks
                    echo '<p>' . implode('<br>', $lines) . '</p>';
                    ?>
                ...
                <div class="b-card7-icon ">
                  <div class="b-card4-content p text-black">
                    ...
                    <!-- <p>05th JUNE 2023<br>10.00 AM</p> -->
                  </div>
                </div>
                <div class="b-card002">
                ...
                <button class="b-card3-icon bg-white" type="button">
                  <div class="b-card3-content text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="red" class="menu-logo">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                    </svg>
                  </div>
              </div>
