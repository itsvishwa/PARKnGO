...
<head>
    ...
    <link rel="stylesheet" href="./styles/deletionView.css" />
    <title>Deletion/Suspend</title>
</head>
            ...
            <div class="business">
                <div class="card-section ">
                    ...
                    <div class="b-card2 bg-white">
                        ...
                        <div class="detail-card bg-primary">
                            <div class="detail-content p text-white">
                                <p>View Details</p>
                            </div>
                        </div>
                        <div class="delete-card2 bg-red">
                ...
                <div class="select-card bg-white">
