...
<head>
  ...
  <link rel="stylesheet" href="./styles/requestsHistoryView.css" />
...
<body>
  <div class="container">
    <div class="left-container">
      <div class="bg-div">
        <img src="../assets/logo-black.png" alt="logo" width="85%" />
        <div>
          <ul class="menu">
            <li>
            ...
            <li class="active">
              <a href="./requestsHistoryView.php">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="menu-logo">
      ...
      <div class="business">
        ...
        <div class="card-section">
          <div class="b-card01 bg-white">
            <div class="b-card1-icon bg-grey">
            ...
            <div class="b-card2-icon bg-white">
