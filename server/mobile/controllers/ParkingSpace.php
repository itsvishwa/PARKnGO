...
class ParkingSpace extends Controller
{
    ...
    // public function status($parking_id) {
    ...
    //             $parking_space_data = $this->parking_space_model->get_parking_space_status_details($parking_id);

    //             // Calculate total free slots
    //             $total_free_slots = 0;
    //             $total_filled_slots = 0;

    //             foreach ($parking_space_data as $space_data) {
    //                 $total_free_slots += $space_data->free_slots;
    //                 $total_filled_slots += ($space_data->total_slots - $space_data->free_slots);
    ...
    //                 "filled_slots" => $total_filled_slots
    //                 //"payment_due" => 
    //             ];

    //             $this->send_json_200($result);

    //             $parking_data = $this->parking_space_model->get_parking_space_details($parking_id);

    //             //$session_ids = $this->session_model->get_all_session_ids_of_parking($parking_id);
